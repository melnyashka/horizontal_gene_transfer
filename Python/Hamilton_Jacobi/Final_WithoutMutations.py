...
figure.savefig(str("Figures/WithoutMutations/plot_" + str(current_time)[0:8].replace(':','_')+".pdf")) # Possibly different delimeter on Linux and Windows!
